...
android {
    ...
    signingConfigs {
        create("release") {
            val storeFile = project.findProperty("SIGNING_KEY_STORE_PATH")
                ?: System.getenv("SIGNING_KEY_STORE_PATH")
            val storePassword = project.findProperty("SIGNING_KEY_STORE_PASSWORD") ?: System.getenv(
                "SIGNING_KEY_STORE_PASSWORD"
            )
            val keyAlias =
                project.findProperty("SIGNING_KEY_ALIAS") ?: System.getenv("SIGNING_KEY_ALIAS")
            val keyPassword = project.findProperty("SIGNING_KEY_PASSWORD")
    ...
    applicationVariants.all {
        ...
        variant.outputs
            ...
            .forEach { output ->
                val outputFileName =
                    "MLScanner-${variant.baseName}-v${variant.versionName}.apk"
...
dependencies {
    ...
    testImplementation(libs.kotlinx.coroutines.test) // Для runTest, StandardTestDispatcher
